...
class DayByDayPlan(BaseModel):
    ...
    notes: str = Field(default="", description="Additional tips, reminders or important information for the day")
...
class HotelResult(BaseModel):
    hotel_name: str = Field(default="", description="Name of the hotel")
    price: str = Field(default="", description="Price of the hotel")
    rating: str = Field(default="", description="Rating of the hotel")
    address: str = Field(default="", description="Address of the hotel")
    amenities: List[str] = Field(default_factory=list, description="Amenities of the hotel")
    description: str = Field(default="", description="Description of the hotel")
    url: str = Field(default="", description="URL of the hotel")


class TravelPlanTeamResponse(BaseModel):
    day_by_day_plan: List[DayByDayPlan] = Field(description="A list of day-by-day plans for the trip")
    hotels: List[HotelResult] = Field(description="A list of hotels for the trip")
    attractions: List[Attraction] = Field(description="A list of recommended attractions for the trip")
    flights: List[FlightResult] = Field(description="A list of flights for the trip")
    restaurants: List[RestaurantResult] = Field(description="A list of recommended restaurants for the trip")
